...
CLASS_NAMES = [
    'Beef', 'BitterGourd', 'BottleGourd', 'Broccoli', 'Cabbage', 'Carrots', 'Cauliflower', 'Chicken', 'Egg', 'Eggplant', 'Galunggong', 'Garlic', 'Ginger', 'Milkfish', 'Onion', 'Papaya', 'Pork', 'Potato', 'Pumpkin', 'Sayote', 'Tilapia', 'Tomato'
]

image_path = Path("E:\PC Storage\School stuff\Python\Screenshot 2026-06-05 123553.png")
...
# path_to_classes_txt = 'datasets/data/category.txt'
# path_to_data_yaml = 'datasets/data/data.yaml'

# # Print the true dictionary the model is using
...
#         cv2.imshow("Detecting Food", frame)
